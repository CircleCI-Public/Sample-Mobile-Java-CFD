 ...
 * Use the {@link PizzaDetail#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PizzaDetail extends Fragment {
     ...
     * @return A new instance of fragment PizzaDetail.
     */
    // TODO: Rename and change types and number of parameters
    public static PizzaDetail newInstance(String param1, String param2) {
        PizzaDetail fragment = new PizzaDetail();
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        TextView countView = view.getRootView().findViewById(R.id.pizza_quantity);
        String countString = countView.getText().toString();
        final Integer[] count = {Integer.parseInt(countString)};

        view.findViewById(R.id.pizza_plus_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                count[0]++;
                TextView quantityView = view.getRootView().findViewById(R.id.pizza_quantity);
                quantityView.setText(count[0].toString());
            }
        });

        view.findViewById(R.id.pizza_minus_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(count[0] > 1) {
                    count[0]--;
